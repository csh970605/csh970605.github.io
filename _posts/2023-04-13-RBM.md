...
During training of the RBM, we can help the Boltzmann machine represent our system by feeding it data through a process called [contrast divergence](https://csh970605.github.io/posts/Contrastive_Divergence/).<br>
...
Now, the backward pass happens. RBM is going to reconstruct inputs.<br>
<br>

During test, there is no process of adjusting weights. That is, **the weights are never modified** basically. It just get a vector as input and tries to fill in the empty values in the vector. At the image above, RBM fills in "Fight Club" and "The Departed".<br>
<br>
...
You can see my implementation on my [Github](https://github.com/csh970605/Deep_Learning_A-Z/tree/main/Part%205%20-%20Boltzman%20Machines/Section%2016%20-%20%20Boltzmann%20Machines)
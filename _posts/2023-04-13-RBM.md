...
<br>
During test, there is no process of adjusting weights. It just get a vector as input and tries to fill in the empty values in the vector. At the image above, RBM fills in "Fight Club" and "The Departed".<br>
<br>
